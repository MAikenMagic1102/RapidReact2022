...
public class Limelight {
	...
	private double RobotHeight = 23;
	private double GoalHeight = 104; //Center of Goal in Inches
	private double MountAngle = 30;
	...
	public double getDistance() {
		return filter.calculate((GoalHeight - RobotHeight) / Math.tan(((MountAngle + this.getTy()) * (3.14159 / 180.0))));	
	}
